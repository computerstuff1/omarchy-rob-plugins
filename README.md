...
Rob's Omarchy bar, menu, system-updates, vitals, and workspaces
plugins. Uses the stock `omarchy.clock`. Drop them into Omarchy with one
command.
...
3. Copies the five `rob.*` plugins into `~/.config/omarchy/plugins/`.
